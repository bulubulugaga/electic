		...
		<view class="demo" :style="'height:' +  demo.height + 'px;' + 'padding-top:' + demo.top + 'px;padding-bottom:10rpx'">
			<view class="left" :style="'top:' + demo.top + 'px'">
				<view class="iconfont icon-xiaoxi">
					...
					<!-- 订单头部客服头像 -->
					<view class="navi-img" v-if="indexSer" @click="toServ()"><image style="width:40rpx;height:48rpx;" src="../static/images/service.png" mode=""></image></view>
					
					<!-- 内页返回 -->
					<view class="navi-img" v-if="conBack" @click.stop="back()"><image style="width:20rpx;height:34rpx;" src="../static/images/back.png" mode=""></image></view>
...
<style>
	...
	.demo{
		...
		background:linear-gradient(to bottom,#23d5b1,#1CC09E);
		font-size: 36rpx;
		z-index: 999;
		color: white;	
	}
